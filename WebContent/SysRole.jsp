			...
			onLoadSuccess:function(data){
				$("#menugrid").datagrid({
					...
					columns:[[
						...
						{field:"state",title:"菜单状态",width:100,align:"center"},
						{field:"remark",title:"菜单备注",width:100,align:"center"}
					]],
					pagination:true,
					pageSize:10,
					fitColumns:true,
...
<body>
	<div style="height: 4%">
		<form name="searchform" method="post" id ="searchform">
			角色名称：<input type="text" name="qname" class="easyui-textbox">
	...
	<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					<td class="right">角色备注：</td>
					<td><input type="text" name="remark" class="easyui-textbox" data-options="required:true"></td>
				</tr>
			</table>
		</form>
	</div>
	<div id="menu" class="easyui-dialog" style="width: 550px;text-align: center;" closed="true">
